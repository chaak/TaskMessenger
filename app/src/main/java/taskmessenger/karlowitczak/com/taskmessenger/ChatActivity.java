...
public class ChatActivity extends AppCompatActivity{
    ...
    private void appendChatConversation(DataSnapshot dataSnapshot) {
        ...
        while (iterator.hasNext()){
            ...
            Drawable toast = getResources().getDrawable(android.R.drawable.toast_frame);
            toast.setColorFilter(Color.BLUE, PorterDuff.Mode.SRC_IN);
            newMessage.setBackground(toast);
